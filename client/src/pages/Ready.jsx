...
export const Ready = () => {
    ...
    const { data, error, isLoading, mutate } = useSWR('/products/ready', Fetch, {
                        ...
                        <div className='flex items-center gap-4'>
                            ...
                            <div>
                                ...
                                <p className='text-gray-600 mt-2'>
                                    Барча Тайёр маҳсулотлар ҳақида маълумот
                                </p>
                            </div>
                        </div>
                        ...
                        <div className='px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50'>
                            <div className='flex items-center justify-between'>
                                <h3 className='text-xl font-semibold text-gray-800 flex gap-1 items-center'>
                                    <Circle size={18} color='blue' /> Маҳсулотлар рўйхати ({filteredProducts.length})
                                </h3>
                                {(searchID ||
                                    searchTitle ||
                                    searchDate ||
